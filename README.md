...
| **Versión actual** | SW v428 (en rama `dev`; **v427 en prod**). v428 centra los filtros + botones del toolbar en pantalla (antes filtros a la izquierda y botones a la derecha con espacio muerto en el medio). v417→v427 desplegados en el día 2026-08-07 (post-outage GH Actions resuelto ~12 UTC). Sesión maratónica: 12 releases consecutivos con fixes UX + nueva sección FORECAST + typos display. |
