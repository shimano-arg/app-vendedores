...
| **Versión actual** | SW v423 (en rama `dev`; **v422 en prod**). v423 renombra los 2 botones Backorders del header: `Backorders` → `Backorder Pendiente` + `Asignación Backorder` → `Backorder Disponible` (más claros para el equipo comercial). v422 desplegado 2026-08-07 12:07 UTC (modal FORECAST admin-only + snapshot `sku_ventas_snapshot`). |
