...
| **Versión actual** | **v914 en dev (2026-09-14)** — Card roja en Confirmados cuando el envío a SAP falla + botón "¿Por qué falló?" con clasificación del error. `transferError` persistido en el pedido doc. Ver §41. |
| **APP_VERSION** | `v914` (sincronizada con `sw.js` CACHE_VERSION). Ver §41 Changelog para historial completo. |
