...
| **Versión actual** | **v945 (2026-09-16)** — Fix: botón "Eliminar" en Master Clientes se renderizaba sin texto (invisible). Ahora dice "Eliminar" en rojo al lado del "Guardar". Afecta tab SAP + tab Provisorios. Ver §41. |
| **APP_VERSION** | `v945` (sincronizada con `sw.js` CACHE_VERSION). Ver §41 Changelog para historial completo. |
