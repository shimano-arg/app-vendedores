...
| **Versión actual** | SW v437 (en rama `dev`; **v436 en prod**). v437: ocultos `.btn-clientes` y `.btn-alta-cli-top` en desktop (@media min-width:769px) — eran redundantes con las tabs CLIENTES y ALTA CLIENTES de la tabs bar del sidebar. Siguen visibles en mobile donde la tabs bar está oculta. |
