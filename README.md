...
| **Versión actual** | SW v416 (en `main`; **v414 en prod** por outage GH — ver Sprint) |
...
- **En `main` local + remoto**: **v416** (v415 + v416 esperando deploy).
...
**Sesión 2026-08-06 tarde (v413 → v416 + fix pipeline GH Pages):**
