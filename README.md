...
| **Versión actual** | **v950 (2026-09-16)** — Backorders Excel: agregada segunda hoja "Forecast" con 1 línea por SKU (agregando unidades e importes de todos los clientes). La hoja "Backorders" original queda igual. Ver §41. |
| **APP_VERSION** | `v950` (sincronizada con `sw.js` CACHE_VERSION). Ver §41 Changelog para historial completo. |
