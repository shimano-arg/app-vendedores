...
| **APP_VERSION** | `v1013` frontend (Planner modal lineas + computeColumn schema real `lines`). Sincronizada con `sw.js` CACHE_VERSION. Ver §41 Changelog para historial completo. |
