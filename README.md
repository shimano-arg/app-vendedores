...
| **Versión actual** | **v949 (2026-09-16)** — HOTFIX: expone `fbDb` como `window.fbDb`. Sin esto la col G del export Backorders v948 salía en 0 (bundle no accedía al snapshot). Ver §41. |
| **APP_VERSION** | `v949` (sincronizada con `sw.js` CACHE_VERSION). Ver §41 Changelog para historial completo. |
