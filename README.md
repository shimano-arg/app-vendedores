...
| **Versión actual** | SW v443 (en rama `dev`; **v442 en prod**). v443: sección Seguimiento distingue **VISITA** (presencial) de **CONTACTO** (no presencial: WhatsApp/tel/email). Nueva card KPI "Contactos" (teal) al lado de "Visitas" (violeta). El resumen por vendedor separa ambas métricas, y cada fila del tab VISITAS muestra un badge del tipo (🚗 VISITA / 💬 CONTACTO). |
