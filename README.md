...
| **Versión actual** | SW v425 (en rama `dev`; **v424 en prod**). v425 gatea los 3 chips del header (role-badge + versión + estado SAP) a Mariano admin y en mobile los reubica a su propia fila debajo del title (antes rompían la visual apretando el título en devices angostos). v424 desplegado 2026-08-07 12:2x UTC (layout modal Backorders). v423 (rename Backorders) + v422 (modal FORECAST) desplegados hoy. |
