...
| **Versión actual** | SW v433 (en rama `dev`; **v432 en prod**). v433: Rendiciones restaurada como TAB en la tabs bar de desktop (entre Alta Clientes y Notificaciones, como estaba pre-v429). En mobile sigue siendo botón toolbar `.btn-rendiciones-top`. Ambos badges se sincronizan del mismo source. |
