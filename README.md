...
| **Versión actual** | SW v442 (en rama `dev`; **v441 en prod**). v442: en cada card del listado CLIENTES/PROSPECTOS aparece un botón "📍 Ver en mapa". Desktop: cierra el modal si está abierto + `map.flyTo` con zoom 15 + scroll al top. Mobile (`<900px`): abre Google Maps en pestaña nueva con `?q=lat,lon` porque el mapa está oculto en mobile. |
