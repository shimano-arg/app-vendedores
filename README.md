...
| **Versión actual** | **v946 (2026-09-16)** — Fix: buscador de Master Clientes tenía lag brutal al escribir (re-render por keystroke sobre 800+ filas). Ahora con debounce 200ms — UX instantánea. Ver §41. |
| **APP_VERSION** | `v946` (sincronizada con `sw.js` CACHE_VERSION). Ver §41 Changelog para historial completo. |
