...
| **Versión actual** | SW v432 (en rama `dev`; **v431 en prod**). v432: agregado botón "Alta clientes" al top toolbar (movido del drawer), y el picker de la 1° ícono del bottom-nav ahora expande POINTS a lista de clientes (SAP + Leads) reales y al elegir llama `openClientMenu()` que muestra las opciones "Crear pedido manual" / "Cargar Excel". |
