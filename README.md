...
| **Versión actual** | SW v418 (en `main`; **v414 en prod** por outage GH — ver Sprint) |
...
- **En `main` local + remoto**: **v418** (v415, v416, v417, v418 esperando deploy).
...
**Sesión 2026-08-06 tarde (v413 → v418 + fix pipeline GH Pages):**
