...
| **Versión actual** | SW v435 (en rama `dev`; **v434 en prod**). v435: el picker de clientes del slot Pedido (bottom-nav mobile) ocupa la pantalla completa (100vh, sin margen, sin radius, sin backdrop-blur) — antes era un modal centrado que se veía "raro" con el teclado abierto (feedback Mariano). Search bar sticky arriba, lista scrollea abajo. |
