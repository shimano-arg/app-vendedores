...
| **Versión actual** | SW v422 (en rama `dev`; **v414 en prod** por outage GH — ver Sprint). v422 agrega modal FORECAST admin-only + snapshot `sku_ventas_snapshot` (BQ v_ventas_lineas 13m → Firestore). |
