...
| **Versión actual** | SW v424 (en rama `dev`; **v423 en prod**). v424 ajusta layout del modal Backorders: los 2 selects (mes + stock) igualan ancho + botón Exportar centrado en su propia fila. v423 desplegado 2026-08-07 12:2x UTC (rename Backorders: `Backorder Pendiente` + `Backorder Disponible`). v422 desplegado 2026-08-07 12:07 UTC (modal FORECAST admin-only + snapshot `sku_ventas_snapshot`). |
