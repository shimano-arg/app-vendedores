...
| **Versión actual** | SW v434 (en rama `dev`; **v433 en prod**). v434: la tab "Rendiciones" en desktop toma el estilo azul marino de la fila 3 (matchea `Alta Clientes` y `Notificaciones`) — agregada a los 5 grupos de selectors `.tab-btn[data-tab=...]` del bloque "Fila 3 AZUL MARINO". |
