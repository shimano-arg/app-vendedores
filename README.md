...
**Total en Power BI post-v367**: **17 vistas curadas** (9 base + 3 deuda + 2 rendiciones + 3 campañas), 2 tablas raw nuevas (`campaigns_raw`, `sap_credit_notes_raw`).
