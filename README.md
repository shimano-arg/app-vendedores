...
**Total en Power BI post-v387**: **19 vistas curadas** (9 base + 3 deuda + 2 rendiciones + 3 campañas + 1 leads + 1 remitos), 4 tablas raw nuevas (`campaigns_raw`, `sap_credit_notes_raw`, `sap_deliveries_raw`, `sap_returns_raw`).
