...
| **Versión actual** | **v866 en main (2026-09-11)** — modal Nueva versión disponible con estilo apple-design (spring entrada + backdrop blur + pill button). Ver §41. |
