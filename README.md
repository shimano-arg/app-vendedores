...
| **APP_VERSION** | `v1007` frontend (idempotencia server-side por `NumAtCard` en CF trigger). Sincronizada con `sw.js` CACHE_VERSION. Ver §41 Changelog para historial completo. |
