...
| **Versión actual** | **v941 (2026-09-15)** — Modal Backorder: eliminada opción "Todos los backorders" del filtro urgencia + default vuelto a "Solo urgentes (sin stock)". Los SKUs parciales siguen accesibles vía dropdown "Solo parciales". Ver §41. |
| **APP_VERSION** | `v941` (sincronizada con `sw.js` CACHE_VERSION). Ver §41 Changelog para historial completo. |
