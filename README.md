...
| **Versión actual** | SW v441 (en rama `dev`; **v440 en prod**). v441: sección Seguimiento — datepickers arrancan en el mes en curso (1 de mes → hoy) en vez de los 90 días atrás por default. Feedback Mariano: el equipo comercial mira seguimiento del mes vigente casi siempre. |
