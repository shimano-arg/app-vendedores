...
| **Versión actual** | SW v430 (en rama `dev`; **v429 en prod**). v430 hotfix: bottom-nav mobile pegado al borde inferior (edge-to-edge, sin gap), slot Productos abre modal por encima del nav (fix z-index), botón Herramientas con texto centrado sin engranaje ni flechita. |
