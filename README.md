...
2. El alert de stock (`checkStock` ~línea 12298) ahora muestra:
   ...
   Total: 180 unidades
   ```
   Si el SKU tiene stock en otros warehouses (98 Cuarentena, etc.) → línea extra `⚠️ Otros almacenes: N unidades (98:N)`.
