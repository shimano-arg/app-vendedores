...
| **Versión actual** | SW v450 (en rama `dev`; **v449 en prod**). v450: `exportMasterClientes` (exports-core.js) ahora agrega **20 columnas de clasificación comercial** desde el formulario de visita/contactado (Tipo comercio, Local, Tamaño, Fidelidad, Especialización, Canal de compra, Relevancia, POP, Necesidad puntual, Tipo de venta, Ponderación mostrador/e-commerce, Competencia, Oportunidad, Más vendido/preguntan, Ayuda tienda, Última interacción, Tipo última interacción, Total visitas, Total contactos). Política: campo por campo, tomar el primer valor NO VACÍO al recorrer visits/contactos de más reciente a más antiguo — así el ultimo formulario prioriza, pero si un contacto reciente no llenó ese campo cae al valor anterior en vez de dejar vacío. Índice `classifIndex: Map<province+localidad+tienda, {merged, lastFecha, lastType, visitas, contactos}>` construido una vez sobre `visitsCache`. Objetivo: Marketing recibe un archivo con toda la clasificación consolidada sin cruzar 3 planillas a mano. |
