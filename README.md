...
| **Versión actual** | SW v417 (en `main`; **v414 en prod** por outage GH — ver Sprint) |
...
- **En `main` local + remoto**: **v417** (v415, v416, v417 esperando deploy).
...
**Sesión 2026-08-06 tarde (v413 → v417 + fix pipeline GH Pages):**
