...
| **Versión actual** | SW v420 (en `main`; **v414 en prod** por outage GH — ver Sprint) |
...
- **En `main` local + remoto**: **v420** (v415-v420 esperando deploy).
...
**Sesión 2026-08-06 tarde (v413 → v420 + fix pipeline GH Pages):**
