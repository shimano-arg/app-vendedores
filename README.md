...
| **Versión actual** | **v867 en main (2026-09-11)** — fix SAP error 1470000315 (agregado UoMEntry:1 en cada línea del SQ) + modal versión estilo apple + SETUP data monitoring. Ver §41. |
