...
| **Versión actual** | SW v438 (en rama `dev`; **v437 en prod**). v438: en el modal Campañas Activas cada tarjeta ahora tiene un desplegable "Editar SKUs (N)" que lista todos los SKUs de la campaña con botón × por cada uno para quitarlos individualmente (arrayRemove atómico de Firestore). Feedback Mariano: "puse SKUs de más y quiero sacar sin borrar toda la campaña". |
