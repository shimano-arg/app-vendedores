      ...
      pedidos: [
        {
          ...
          data: {
            ...
            closedAt: null,
            lines: [
              { code: 'SKU-X', qty: 70, qtyInvoiced: 0, qtyCancelled: 0, qtyRecycled: 0, qtyOpen: 70, state: 'confirmed' },
              { code: 'SKU-X', qty: 30, qtyInvoiced: 0, qtyCancelled: 0, qtyRecycled: 0, qtyOpen: 30, state: 'BO' },
            ],
            sapLinkage: {},
          },
        },
      ...
      pedidos: [
        {
          ...
          data: {
            ...
            closedAt: null,
            lines: [
              { code: 'SKU-Y', qty: 50, qtyInvoiced: 0, qtyCancelled: 0, qtyRecycled: 0, qtyOpen: 50, state: 'confirmed' },
              { code: 'SKU-Y', qty: 20, qtyInvoiced: 0, qtyCancelled: 0, qtyRecycled: 0, qtyOpen: 20, state: 'confirmed' },
            ],
            sapLinkage: {},
          },
        },
      ...
      pedidos: [
        {
          ...
          data: {
            ...
            closedAt: null,
            lines: [
              { code: 'SKU-Z', qty: 20, qtyInvoiced: 0, qtyCancelled: 0, qtyRecycled: 0, qtyOpen: 20, state: 'BO' },
            ],
            sapLinkage: {},
          },
        },
      ...
      pedidos: [
        {
          ...
          data: {
            ...
            closedAt: null,
            lines: [
              { code: 'SKU-W', qty: 70, qtyInvoiced: 70, qtyCancelled: 0, qtyRecycled: 0, qtyOpen: 0, state: 'invoiced' },
              { code: 'SKU-W', qty: 30, qtyInvoiced: 0, qtyCancelled: 0, qtyRecycled: 0, qtyOpen: 30, state: 'BO' },
            ],
            sapLinkage: {},
          },
        },
      ...
      pedidos: [
        {
          ...
          data: {
            ...
            closedAt: null,
            lines: [
              { code: 'SKU-V', qty: 40, qtyInvoiced: 0, qtyCancelled: 0, qtyRecycled: 0, qtyOpen: 40, state: 'confirmed' },
              { code: 'SKU-V', qty: 10, qtyInvoiced: 0, qtyCancelled: 0, qtyRecycled: 0, qtyOpen: 10, state: 'ASIG' },
            ],
            sapLinkage: {},
          },
        },
